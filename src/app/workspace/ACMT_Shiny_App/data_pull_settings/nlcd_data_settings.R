...
library(magrittr)
source('~/workspace/ACMT_Shiny_App/data_pull_settings/NLCD_UTILITY_FUNCTIONS.R')
...
nlcd_description<-'The National Land Cover Database uses satellite imagery to create pixel-by-pixel 
maps of land cover features. Areas of 30-meters are categorized into land cover classes including 
forest, low-, medium-, and high-intensity developed, and more. 
For more information about the NLCD, visit this link: https://www.usgs.gov/news/technical-announcement/new-land-cover-maps-capture-nearly-two-decades-change-across-us'
